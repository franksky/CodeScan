...
package com.frank.codescan.config;
...
public final class Config {
    ...
    //config ip address
    public static final String KEY_IP_ADDRESS = "http://182.92.240.245:8080/SignService2/client";

    //xingfujia_piyi
    public static final int SYSTEM_ID = 1001;
